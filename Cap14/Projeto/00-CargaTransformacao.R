...
if(Azure) {
  ...
  # Selecionas as variáveis que serão usadas
...
# Adiciona uma variável com valores únicos para o horario do dia em dias de semana e dias de fim de semana
...
# Adiciona uma variável com valores únicos para o horário do dia para dias de seman e dias de fim de semana
