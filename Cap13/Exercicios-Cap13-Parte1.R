...
# Faça as previsões
prediction <- predict(model, testHouseVotes84[, -1])

# Crie a Confusion matrix
table(prediction, testHouseVotes84$Class)

# Média
mean(prediction == testHouseVotes84$Class)
...
# Os resultados das exeuções estão bem próximos, entre 0.87 e 0.95
# com oum desvio padrão de 0.02.
