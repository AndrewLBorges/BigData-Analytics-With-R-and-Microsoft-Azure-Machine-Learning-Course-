...
# CK ≈ 3: Distribuição normal. Chamada de Curtose Mesocúrtica.
# CK < 3: Cauda mais leve que a normal. Para um coeficiente de Curtose negativo, tem-se uma Curtose Platicúrtica.
# CK > 3: Cauda mais pesada que a normal. Para um coeficiente de Curtose positivo, tem-se uma Curtose Leptocúrtica.

# O coeficiente de curtose é igual a 2.37652. Logo, como o valor de CK é menor que 3, a curva é Platicúrtica.
