...
# unlist()
# produces a vector with the list elements
?unlist
...
# do.call()
# executes a function on an object
?do.call
...
# we can get the same result as lapply() via other packages
...
# strsplit()
# divides a string or a vector of characters
...
# Does an unlist() transforming the list to matrix
