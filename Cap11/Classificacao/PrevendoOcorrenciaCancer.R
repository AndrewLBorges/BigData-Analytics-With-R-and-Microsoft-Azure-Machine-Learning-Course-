...
# Os dados do câncer de mama incluem 569 observações de biópsias de câncer,
...
# que inclui um identificador pde sofrer de superajuste(overfitting),
...
# O cálculo de distância feito pelo KNN édependente das medidas de escala nos dados de entrada.
...
# Experimente diferentes alores para k
