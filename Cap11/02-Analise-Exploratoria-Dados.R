...
##### Análise Exploratória de Dados Para Variváves Numéricas #####
...
hist(carros$kilometragem, main = "Histograma para a Km de Carros Usados", xlab = "Kilometragem(Km)")
hist(carros$kilometragem, main = "Histograma para a Km de Carros Usados", breaks = 5, xlab = "Kilometragem(Km)")
...
# que são classificados de acordo com duas variáveis categóricas.
# Os elementos de uma categoria são exibidos através das colunas;
# os elementos de outra categoria são exibidos sobre as linhas.
...
# Qui Quadrado, simbolizado por X2 é um teste de
...
# parãmetros populacionais, como média e variãncia.
